  ...
  return (
    ...
    >
      {/* 
        ...
        Locks to the screen at top-24 sm:top-28 md:top-32 with plenty of clearance below the navbar,
        then smoothly unpins into the next section with ZERO extra whitespace.
      */}
      <div className="sticky top-24 sm:top-28 md:top-32 flex flex-col justify-start z-20 px-3 sm:px-6">
        <div className="container-app w-full max-w-5xl mx-auto">
          
          {/* COMIC NOTEBOOK SHOWCASE BOOKLET */}
          <div className="relative rounded-[2.2rem] sm:rounded-[2.8rem] bg-[#FFFDF9] border-3 sm:border-4 border-neutral-900 shadow-[8px_8px_0px_0px_#18181B] sm:shadow-[12px_12px_0px_0px_#18181B] overflow-hidden transition-all">
            
            {/* SPIRAL BINDER STRIP ON TOP (Authentic Notebook Feel) */}
            <div className="bg-[#FAF7EE] border-b-3 border-neutral-900 px-4 sm:px-6 py-2 flex items-center justify-between relative select-none">
            ...
            <div 
              className="p-4 sm:p-6 lg:p-7 relative bg-[#FFFDF9]"
              style={{
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-4 sm:mb-5 pb-3 sm:pb-4 border-b-2 border-dashed border-neutral-300">
                <div>
                  <div className="inline-flex items-center gap-2 px-3 py-0.5 rounded-full bg-yellow-100 border-2 border-neutral-900 text-neutral-900 text-xs font-display font-black mb-1 shadow-[2px_2px_0px_0px_#18181B]">
                    <Sparkles className="w-3.5 h-3.5 text-brand-purple" />
                    <span>How Children Master Language With Lingo Toon</span>
                  </div>
                  <h3 className="font-display text-xl sm:text-2xl lg:text-3xl font-black text-neutral-900 tracking-tight">
                  ...
                  {steps.map((step, idx) => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-3 sm:px-3.5 py-1.5 rounded-xl font-display font-black text-xs sm:text-sm border-2 transition-all transform duration-200 cursor-pointer ${
                          isCurrent
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8 items-center">
                ...
                <div className="lg:col-span-6 space-y-2.5 sm:space-y-3.5">
                  {/* Comic Bubble Pill */}
                  <div className="flex items-center gap-2">
                    <span className={`text-xs font-display font-black tracking-wider px-3 py-0.5 rounded-full border-2 border-neutral-900 shadow-[2px_2px_0px_0px_#18181B] ${current.tagColor}`}>
                  ...
                  {/* Main Headline */}
                  <h2 className="font-display font-black text-2xl sm:text-3xl lg:text-4xl text-neutral-900 leading-tight">
                    {current.title}
                  </h2>

                  {/* Subtitle */}
                  <h4 className="font-display font-extrabold text-xs sm:text-sm text-brand-purple">
                    {current.subtitle}
                  </h4>

                  {/* Paragraph Description */}
                  <p className="font-body text-xs sm:text-sm text-neutral-700 font-semibold leading-relaxed line-clamp-3 sm:line-clamp-none">
                    {current.description}
                  </p>
                  ...
                  <div className="pt-0.5 flex items-center gap-2.5">
                    ...
                    <span className="font-display font-black text-xs px-3 py-0.5 rounded-lg bg-yellow-100 border-2 border-neutral-900 text-neutral-900 shadow-[2px_2px_0px_0px_#18181B] transform -rotate-1">
                      {current.stat}
                    </span>
                  </div>
                  ...
                  <div className="pt-2">
                    <Link to={current.link} onClick={() => sounds.playPop()}>
                      <button className="px-6 sm:px-8 py-2.5 sm:py-3 rounded-full bg-neutral-900 hover:bg-neutral-800 text-white font-display font-black text-xs sm:text-sm border-2 border-neutral-900 shadow-[4px_4px_0px_0px_#FFD53D] hover:shadow-[6px_6px_0px_0px_#FFD53D] transition-all transform hover:-translate-y-0.5 active:translate-y-0.5 flex items-center gap-2">
                ...
                <div className="lg:col-span-6">
                  <div className={`relative aspect-[16/10] max-h-[220px] sm:max-h-[260px] lg:max-h-[280px] rounded-[1.8rem] sm:rounded-[2.2rem] p-2.5 sm:p-3.5 border-3 sm:border-4 border-neutral-900 shadow-[6px_6px_0px_0px_#18181B] overflow-hidden ${current.panelBg} transition-all duration-300`}>
                    {/* Inner Comic Art Box */}
                    <div className="w-full h-full rounded-[1.4rem] overflow-hidden relative border-2 border-neutral-900 shadow-inner bg-neutral-900 group">
                      <img
                        key={current.image}
                        src={current.image}
                        alt={current.title}
                      ...
                      <div className="absolute top-2.5 left-2.5 bg-white/95 border-2 border-neutral-900 px-2.5 py-0.5 rounded-md font-display font-black text-[10px] sm:text-[11px] text-neutral-900 shadow-[2px_2px_0px_0px_#18181B] transform -rotate-2">
                        {current.stickerText}
                      </div>

                      {/* Bottom Step Indicator Pill */}
                      <div className="absolute bottom-2.5 left-2.5 bg-neutral-900/95 text-white border border-white/20 px-3 py-0.5 rounded-full text-xs font-display font-black flex items-center gap-2 shadow-md">
              ...
              <div className="mt-4 sm:mt-5 pt-3 border-t-2 border-dashed border-neutral-300 flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 text-xs font-display font-black text-neutral-600">
                <div className="flex items-center gap-2">
