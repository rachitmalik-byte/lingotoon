                ...
                {isPlayingEmbed ? (
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="absolute inset-0 m-auto w-16 sm:w-20 h-16 sm:h-20 rounded-full bg-red-600 hover:bg-red-700 text-white flex items-center justify-center shadow-2xl transform group-hover:scale-115 active:scale-95 transition-all duration-300"
            ...
            <div className="lg:col-span-5 space-y-5">
              ...
              <div className="pt-2 flex flex-col sm:flex-row gap-3">
                <a
                  ...
                  className="flex-1 py-3.5 px-6 rounded-full bg-red-600 hover:bg-red-700 text-white font-display font-bold text-sm shadow-md hover:shadow-lg transition-all transform hover:scale-102 active:scale-98 flex items-center justify-center gap-2"
                >
                  <Youtube className="w-4 h-4 fill-current" />
                ...
                {!isPlayingEmbed && (
                  <button
                    onClick={() => { sounds.playFanfare(); setIsPlayingEmbed(true); }}
                    className="py-3.5 px-6 rounded-full bg-white hover:bg-neutral-50 text-neutral-800 font-display font-bold text-sm border-2 border-neutral-200 transition-all flex items-center justify-center gap-1.5"
                  >
